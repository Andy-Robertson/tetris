document.addEventListener('DOMContentLoaded', () => {
  ...
  // move the tetromino righ, unless is at the edge or there is a blockage
  function moveRight () {
    undraw()
  ...
  function rotate () {
    undraw()
    currentRotation++
    if (currentRotation === current.length) { // if the current rotation gets to 4, make it go backto 0
      currentRotation = 0
    }
    current = theTetrominoes[random][currentRotation]
    draw()
